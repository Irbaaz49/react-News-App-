...
export class News extends Component {
    ...
    render() {
        return (
            <>
                <h1 className="text-center" style={{ margin: '35px 0px' }}>NewsApp -<span class="badge bg-secondary">Top {this.capitalizeFirstLetter(this.props.category)} Headlines</span> </h1>
